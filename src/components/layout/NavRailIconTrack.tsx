...
export function NavRailIconTrack({ children, className }: NavRailIconTrackProps) {
    return <span className={clsx(navRailIconColumnClassName, className)}>{children}</span>;
}
