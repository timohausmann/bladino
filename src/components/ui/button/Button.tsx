...
function resolveEffect(_variant: ButtonVariant, effect?: ButtonEffect): ButtonEffect {
...
export function Button({
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLButtonElement>) => {
        if (showGlow && !loading) updateGlowTarget(e.currentTarget, e.clientX, e.clientY);
        onMouseMove?.(e);
    };
    ...
    return (
        <button
            ...
            aria-label={rest['aria-label'] ?? (typeof children === 'string' ? children : label)}
