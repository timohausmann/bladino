 ...
 */
type Documents = {
    "mutation Login($name: String!, $password: String!) {\n  login(name: $name, password: $password)\n}\n\nmutation RequestMagic($handle: String!) {\n  requestMagic(handle: $handle)\n}\n\nmutation LoginMagic($token: String!) {\n  loginMagic(token: $token)\n}\n\nmutation UpdatePassword($id: ID!, $newpass: String!, $oldpass: String!) {\n  updatePassword(id: $id, newpass: $newpass, oldpass: $oldpass)\n}\n\nquery CurrentUser {\n  currentUser {\n    id\n    name\n    avatar\n    email\n    description\n    dateCreated\n  }\n}": typeof types.LoginDocument,
    ...
    "query Mails($folder: String) {\n  mails(folder: $folder) {\n    id\n    subject\n    from\n    to\n    dateReceived\n    dateSent\n    unread\n    folder\n  }\n}\n\nquery Mail($id: ID!) {\n  mail(id: $id) {\n    id\n    subject\n    from\n    to\n    cc\n    bcc\n    body\n    dateReceived\n    dateSent\n    unread\n    folder\n  }\n}\n\nmutation SendEmail($to: [String]!, $subject: String!, $body: String!, $cc: [String], $bcc: [String]) {\n  sendEmail(to: $to, subject: $subject, body: $body, cc: $cc, bcc: $bcc)\n}": typeof types.MailsDocument,
    "query Notes {\n  notes {\n    id\n    title\n    body\n    dateCreated\n    dateEdited\n  }\n}\n\nquery Note($id: ID!) {\n  note(id: $id) {\n    id\n    title\n    body\n    dateCreated\n    dateEdited\n  }\n}\n\nmutation AddNote($body: String, $title: String) {\n  addNote(body: $body, title: $title) {\n    id\n    title\n    body\n    dateCreated\n    dateEdited\n  }\n}\n\nmutation UpdateNote($id: ID!, $body: String, $title: String) {\n  updateNote(id: $id, body: $body, title: $title) {\n    id\n    title\n    body\n    dateCreated\n    dateEdited\n  }\n}\n\nmutation DeleteNote($id: ID!) {\n  deleteNote(id: $id)\n}": typeof types.NotesDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment VoteFields on Vote {\n  id\n  user {\n    id\n    name\n    avatar\n  }\n}"): (typeof documents)["fragment VoteFields on Vote {\n  id\n  user {\n    id\n    name\n    avatar\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Mails($folder: String) {\n  mails(folder: $folder) {\n    id\n    subject\n    from\n    to\n    dateReceived\n    dateSent\n    unread\n    folder\n  }\n}\n\nquery Mail($id: ID!) {\n  mail(id: $id) {\n    id\n    subject\n    from\n    to\n    cc\n    bcc\n    body\n    dateReceived\n    dateSent\n    unread\n    folder\n  }\n}\n\nmutation SendEmail($to: [String]!, $subject: String!, $body: String!, $cc: [String], $bcc: [String]) {\n  sendEmail(to: $to, subject: $subject, body: $body, cc: $cc, bcc: $bcc)\n}"): (typeof documents)["query Mails($folder: String) {\n  mails(folder: $folder) {\n    id\n    subject\n    from\n    to\n    dateReceived\n    dateSent\n    unread\n    folder\n  }\n}\n\nquery Mail($id: ID!) {\n  mail(id: $id) {\n    id\n    subject\n    from\n    to\n    cc\n    bcc\n    body\n    dateReceived\n    dateSent\n    unread\n    folder\n  }\n}\n\nmutation SendEmail($to: [String]!, $subject: String!, $body: String!, $cc: [String], $bcc: [String]) {\n  sendEmail(to: $to, subject: $subject, body: $body, cc: $cc, bcc: $bcc)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
